  ...
  return (
    <>
      <section className="relative flex flex-col justify-center items-center px-6 py-10 sm:px-12 lg:px-28 rounded-4xl gap-12 lg:py-20 w-full overflow-hidden">
        ...
        <div className="relative z-10 px-6 py-3 bg-white/5 border border-white/10 shadow-sm backdrop-blur-2xl rounded-full flex justify-center items-center gap-2.5">
